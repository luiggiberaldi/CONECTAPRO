                ...
                {navigation.map((item) => {
                  ...
                  return (
                    <Link
                      key={item.href}
                      href={item.href}
                      className={`flex items-center gap-2 px-3 py-2.5 rounded-xl text-xs font-semibold whitespace-nowrap transition-all active:scale-97 ${
                        isActive
                          ? 'bg-rose-500/10 text-rose-600 dark:text-rose-400 font-bold border-l-2 border-rose-500 rounded-l-none'
